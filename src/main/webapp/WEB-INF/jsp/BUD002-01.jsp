...
<body class="main_body">
	...
	<div id="container">
		...
		<form:form action="/StudentManagement-SpringMVC-Hibernate/studentUpdate"
					...
					<div class="search_form">
						...
						<div id="btnGroup">
							<input type="submit" value="Update" class="button"
								onclick="javascript:update()" /> <a href="/StudentManagement-SpringMVC-Hibernate/studentDelete/${studentId}"><input type="button"
								value="Delete" id="delete" class="button"
								onclick="javascript:deleteBudget()" /></a> <input type="button"
								value="Back" class="button"
								onclick="window.location.replace('/StudentManagement-SpringMVC-Hibernate/studentsearch')" />
						</div>
					</div>
				</div>
			</div>
