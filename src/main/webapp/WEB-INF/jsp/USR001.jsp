		...
		<div id="main_contents">
			<div id="contents">
				<div class="search_form">
					<h3>User Search</h3>
					<form:form action="/StudentManagement-SpringMVC-Hibernate/searchUser" method="get" modelAttribute="usBean">
						...
						<br /> <input type="submit" value="Search" class="button"
							onclick="searchList()" /> <a href="/StudentManagement-SpringMVC-Hibernate/userRegister"> <input
							type="button" value="Add" class="button" id="userInsert" />
						</a> <input type="button" value="Reset" class="button"
							onclick="location.href='/StudentManagement-SpringMVC-Hibernate/usermanagement'" />
					</form:form>
					<br /> <br />
					<div id="errormsg">
				...
				<div id="list">
					<table class="resultTable">
						...
						<c:forEach items="${userList}" var="ul">
							<tr>
								<td><a href="/StudentManagement-SpringMVC-Hibernate/deleteUser/${ul.id}"><input type="button" value="Delete" id="deleteuser" class="button"
											onclick="javascript:checkDelete()" /></a>
									</td>
								<td><a href="/StudentManagement-SpringMVC-Hibernate/updateUserModel/${ul.id}"> <input
