		...
		<div id="main_contents">
			<div id="contents">
				<div class="search_form">
					...
					<form:form
						action="/StudentManagement-SpringMVC-Hibernate/studentResult"
						...
						<input type="button" value="Reset"
							onclick="location.href='/StudentManagement-SpringMVC-Hibernate/studentsearch'" class="button" />
						<br />
						<br />
						<div id="errormsg">
							...
							<table class="resultTable">
								...
								<c:forEach items="${ stuList }" var="st">
									...
									<tr>
										...
										<td>${st.studentId}</td>
										<td><a
											href="/StudentManagement-SpringMVC-Hibernate/studentUpdateModel/${st.studentId}">${st.studentName}</a></td>
										<td>${st.className}</td>
